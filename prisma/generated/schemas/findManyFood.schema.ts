...
export const FoodFindManySelectSchema: z.ZodType<Prisma.FoodSelect> = z.object({
...
export const FoodFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    storeId: z.boolean().optional(),
    store: z.boolean().optional(),
    item: z.boolean().optional(),
...
export const FoodFindManySchema: z.ZodType<Prisma.FoodFindManyArgs> = z.object({ select: FoodFindManySelectSchema.optional(), include: z.lazy(() => FoodIncludeObjectSchema.optional()), orderBy: z.union([FoodOrderByWithRelationInputObjectSchema, FoodOrderByWithRelationInputObjectSchema.array()]).optional(), where: FoodWhereInputObjectSchema.optional(), cursor: FoodWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FoodScalarFieldEnumSchema, FoodScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.FoodFindManyArgs>;

export const FoodFindManyZodSchema = z.object({ select: FoodFindManySelectSchema.optional(), include: z.lazy(() => FoodIncludeObjectSchema.optional()), orderBy: z.union([FoodOrderByWithRelationInputObjectSchema, FoodOrderByWithRelationInputObjectSchema.array()]).optional(), where: FoodWhereInputObjectSchema.optional(), cursor: FoodWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FoodScalarFieldEnumSchema, FoodScalarFieldEnumSchema.array()]).optional() }).strict();