...
export const StoreFindFirstSchema: z.ZodType<Prisma.StoreFindFirstArgs> = z.object({ select: StoreFindFirstSelectSchema.optional(), include: z.lazy(() => StoreIncludeObjectSchema.optional()), orderBy: z.union([StoreOrderByWithRelationInputObjectSchema, StoreOrderByWithRelationInputObjectSchema.array()]).optional(), where: StoreWhereInputObjectSchema.optional(), cursor: StoreWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StoreScalarFieldEnumSchema, StoreScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.StoreFindFirstArgs>;

export const StoreFindFirstZodSchema = z.object({ select: StoreFindFirstSelectSchema.optional(), include: z.lazy(() => StoreIncludeObjectSchema.optional()), orderBy: z.union([StoreOrderByWithRelationInputObjectSchema, StoreOrderByWithRelationInputObjectSchema.array()]).optional(), where: StoreWhereInputObjectSchema.optional(), cursor: StoreWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StoreScalarFieldEnumSchema, StoreScalarFieldEnumSchema.array()]).optional() }).strict();