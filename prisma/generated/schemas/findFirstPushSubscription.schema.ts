...
export const PushSubscriptionFindFirstSelectSchema: z.ZodType<Prisma.PushSubscriptionSelect> = z.object({
...
export const PushSubscriptionFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    endpoint: z.boolean().optional(),
    p256dh: z.boolean().optional(),
    auth: z.boolean().optional(),
...
export const PushSubscriptionFindFirstSchema: z.ZodType<Prisma.PushSubscriptionFindFirstArgs> = z.object({ select: PushSubscriptionFindFirstSelectSchema.optional(), include: z.lazy(() => PushSubscriptionIncludeObjectSchema.optional()), orderBy: z.union([PushSubscriptionOrderByWithRelationInputObjectSchema, PushSubscriptionOrderByWithRelationInputObjectSchema.array()]).optional(), where: PushSubscriptionWhereInputObjectSchema.optional(), cursor: PushSubscriptionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PushSubscriptionScalarFieldEnumSchema, PushSubscriptionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PushSubscriptionFindFirstArgs>;

export const PushSubscriptionFindFirstZodSchema = z.object({ select: PushSubscriptionFindFirstSelectSchema.optional(), include: z.lazy(() => PushSubscriptionIncludeObjectSchema.optional()), orderBy: z.union([PushSubscriptionOrderByWithRelationInputObjectSchema, PushSubscriptionOrderByWithRelationInputObjectSchema.array()]).optional(), where: PushSubscriptionWhereInputObjectSchema.optional(), cursor: PushSubscriptionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PushSubscriptionScalarFieldEnumSchema, PushSubscriptionScalarFieldEnumSchema.array()]).optional() }).strict();