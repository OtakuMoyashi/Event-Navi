...
export const StockLogFindManySelectSchema: z.ZodType<Prisma.StockLogSelect> = z.object({
...
export const StockLogFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    itemId: z.boolean().optional(),
    item: z.boolean().optional(),
    change: z.boolean().optional(),
...
export const StockLogFindManySchema: z.ZodType<Prisma.StockLogFindManyArgs> = z.object({ select: StockLogFindManySelectSchema.optional(), include: z.lazy(() => StockLogIncludeObjectSchema.optional()), orderBy: z.union([StockLogOrderByWithRelationInputObjectSchema, StockLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: StockLogWhereInputObjectSchema.optional(), cursor: StockLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StockLogScalarFieldEnumSchema, StockLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.StockLogFindManyArgs>;

export const StockLogFindManyZodSchema = z.object({ select: StockLogFindManySelectSchema.optional(), include: z.lazy(() => StockLogIncludeObjectSchema.optional()), orderBy: z.union([StockLogOrderByWithRelationInputObjectSchema, StockLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: StockLogWhereInputObjectSchema.optional(), cursor: StockLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StockLogScalarFieldEnumSchema, StockLogScalarFieldEnumSchema.array()]).optional() }).strict();