...
export const PushSubscriptionFindManySelectSchema: z.ZodType<Prisma.PushSubscriptionSelect> = z.object({
...
export const PushSubscriptionFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    endpoint: z.boolean().optional(),
    p256dh: z.boolean().optional(),
    auth: z.boolean().optional(),
