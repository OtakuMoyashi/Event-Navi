...
export const AttractionFindManySelectSchema: z.ZodType<Prisma.AttractionSelect> = z.object({
...
export const AttractionFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    storeId: z.boolean().optional(),
    store: z.boolean().optional(),
    tickets: z.boolean().optional(),
...
export const AttractionFindManySchema: z.ZodType<Prisma.AttractionFindManyArgs> = z.object({ select: AttractionFindManySelectSchema.optional(), include: z.lazy(() => AttractionIncludeObjectSchema.optional()), orderBy: z.union([AttractionOrderByWithRelationInputObjectSchema, AttractionOrderByWithRelationInputObjectSchema.array()]).optional(), where: AttractionWhereInputObjectSchema.optional(), cursor: AttractionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AttractionScalarFieldEnumSchema, AttractionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AttractionFindManyArgs>;

export const AttractionFindManyZodSchema = z.object({ select: AttractionFindManySelectSchema.optional(), include: z.lazy(() => AttractionIncludeObjectSchema.optional()), orderBy: z.union([AttractionOrderByWithRelationInputObjectSchema, AttractionOrderByWithRelationInputObjectSchema.array()]).optional(), where: AttractionWhereInputObjectSchema.optional(), cursor: AttractionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AttractionScalarFieldEnumSchema, AttractionScalarFieldEnumSchema.array()]).optional() }).strict();