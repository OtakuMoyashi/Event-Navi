...
export const AttractionFindFirstSelectSchema: z.ZodType<Prisma.AttractionSelect> = z.object({
...
export const AttractionFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    storeId: z.boolean().optional(),
    store: z.boolean().optional(),
    tickets: z.boolean().optional(),
...
export const AttractionFindFirstSchema: z.ZodType<Prisma.AttractionFindFirstArgs> = z.object({ select: AttractionFindFirstSelectSchema.optional(), include: z.lazy(() => AttractionIncludeObjectSchema.optional()), orderBy: z.union([AttractionOrderByWithRelationInputObjectSchema, AttractionOrderByWithRelationInputObjectSchema.array()]).optional(), where: AttractionWhereInputObjectSchema.optional(), cursor: AttractionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AttractionScalarFieldEnumSchema, AttractionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AttractionFindFirstArgs>;

export const AttractionFindFirstZodSchema = z.object({ select: AttractionFindFirstSelectSchema.optional(), include: z.lazy(() => AttractionIncludeObjectSchema.optional()), orderBy: z.union([AttractionOrderByWithRelationInputObjectSchema, AttractionOrderByWithRelationInputObjectSchema.array()]).optional(), where: AttractionWhereInputObjectSchema.optional(), cursor: AttractionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AttractionScalarFieldEnumSchema, AttractionScalarFieldEnumSchema.array()]).optional() }).strict();